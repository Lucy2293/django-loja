...
from .views import CategoriaListView, CategoriaCreateView, ProdutoListView, ProdutoCreateView, ProdutoUpdateView, ProdutoDeleteView,  CategoriaUpdateView, CategoriaDeleteView
